<header style="font-family:Helvetica, Arial, sans-serif;">
    <nav style="font-family:Helvetica, Arial, sans-serif;">
        ...
        <h1 style="font-family:Helvetica, Arial, sans-serif;font-size:1.8em;">
            <?= $this->url->link('<img alt="logo" width="30" height="25" style="color: #ccc;" src="'.$this->url->dir().'assets/svg/home.svg">', 'app', 'index', array(), false, '', t('Dashboard')).' '.$this->e($title) ?><!-- 'logo' -->
